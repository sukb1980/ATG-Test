        ...
        <div className="w-full fade-in">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                <div className="glass-panel p-6 flex flex-col items-center justify-center text-center">
                    <span className="text-4xl font-bold text-white mb-1">1,240</span>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="lg:col-span-2 glass-panel p-6">
                    ...
                    <div className="space-y-4">
                        {EMPLOYEES.map((emp) => (
                            <div key={emp.name} className="flex items-center justify-between p-4 bg-white/5 rounded-xl border border-white/5 hover:border-pink-500/30 transition-colors">
                                <div className="flex items-center gap-4">
                                    <div className="w-10 h-10 rounded-full bg-slate-700 flex items-center justify-center text-white font-bold">{emp.name.charAt(0)}</div>
                                    <div>
                ...
                <div className="glass-panel p-6">
                    ...
                    <div className="space-y-3">
                        <button className="w-full text-left px-4 py-3 rounded-xl bg-pink-600/10 hover:bg-pink-600/20 border border-pink-500/30 text-pink-100 transition-colors flex items-center gap-3">
